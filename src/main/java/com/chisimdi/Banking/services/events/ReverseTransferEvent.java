...
public class ReverseTransferEvent {
    String contactInfo;
    String name;
    ...
    public ReverseTransferEvent(String contactInfo, String name, String receiversAccountNumber,String sendersAccountNUmber, Double amount ){
        this.amount=amount;
        this.name=name;
